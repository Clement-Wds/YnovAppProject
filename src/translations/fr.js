export default {
  translation: {
    resources: {
      ...
      header: {
        title: 'Bonjour',
        description: "Ceci est la page d'en-tête",
      ...
      library: {
        title: 'Bibliothèque',
        description: 'Ceci est la page de la bibliothèque',
      },
      search: {
        title: 'Chercher',
        description: 'Ceci est la page de recherche',
        seeAll: 'Parcourir tout',
        placeholder:
          'Rechercher une chanson, un artiste, un album ou une liste de lecture',
      },
      register: {
        title: "S'inscrire",
